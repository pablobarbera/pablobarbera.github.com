...
\item[35.] Munzert, S., Traunmüller, R., \textbf{Barber\'{a}, P.}, Guess, A. \& Yang, J. \href{https://academic.oup.com/pnasnexus/advance-article/doi/10.1093/pnasnexus/pgaf032/8010228}{``Citizen preferences for online hate speech regulation,''} \textit{PNAS Nexus}, forthcoming.

\item[34.] Licht, H., Abou-Chadi, T., \textbf{Barber\'{a}, P.} \& Hua, W \href{https://www.journals.uchicago.edu/doi/abs/10.1086/730711}{``Measuring and understanding parties’ anti-elite strategies,''}  \textit{Journal of Politics}, forthcoming.
...
\begin{itemize}
\item[] $\ast$ Recipient of the 2024 \href{https://apsanet.org/membership/organized-sections/organized-section-awards/past-awards/section-41/#political%20ties}{Political Ties Award}
\end{itemize}
...
\emph{Member of dissertation committees:} Adam Badawy (USC), Whitney Hua (USC), Fridolin Linder (Penn State), Xinru Ma (USC), Marius S\"{a}ltzer (Mannheim), Philipp Kling (Konstanz), Joshua Timm (USC), Joe Hoover (USC), Timo Daehler (USC), Anuja Majmundar (USC), Meiqing Zhang (USC), Florence Ecormier-Nocca (SciencesPo), Will Godel (NYU), Herbert Chang (USC), Angela Lai (NYU), Julie Jiang (USC).
