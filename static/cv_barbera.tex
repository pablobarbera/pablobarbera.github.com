...
%__________________________________________________________________________________________________________________
    ...
    \begin{itemize}
    \item[] Assistant Professor, School of International Relations, 2016-- (currently on leave)
    \vspace{-.15cm}
...
\section{\mysidestyle Other\\Publications}
    \vspace{.15cm}    
\begin{itemize}[leftmargin=5.5mm]
\item[3.]  \textbf{Barber\'{a}, P.} \href{http://comparativenewsletter.com/files/archived_newsletters/2018_fall.pdf}{``Explaining the Spread of Misinformation on Social Media: Evidence from the 2016 U.S. Presidential Election''}, APSA \textit{Comparative Politics Newsletter}, 2018.   
...
\textbf{Barber\'{a}, P.}, Casas. A, Nagler, J., Egan, P., Bonneau, R., Jost, J. \& Tucker, J. ``Leaders or Followers? Measuring Political Responsiveness in the U.S. Congress Using Social Media Data'', Revised and Resubmitted to the \textit{American Political Science Review}.

Fazekas, Z., Popa, S., Schmitt, H., \textbf{Barber\'{a}, P.} \& Theocharis, Y. ``Elite-Public Interaction on Twitter: The EU Issue in the 2014 EP Campaign'', \textit{under review}.

\textbf{Barber\'{a}, P.}, Theocharis, Y., Popa, S., Fazekas, Z. ``The Dynamics of Citizen Incivility Towards Politicians'', \textit{under review}

Siegel, A., Nikitin, E., \textbf{Barber\'{a}, P.}, Sterling, J., Pullen, B., Bonneau, R., Nagler, J. \& Tucker, J. ``Trumping Hate on Twitter? Online Hate Speech and White Nationalist Rhetoric in the 2016 US Election Campaign and its Aftermath'', \textit{under review}.
...
Munzert, S., \textbf{Barber\'{a}, P.}, Guess, A. \& Yang, J. ``What and How Do Citizens Learn from Voting Advice Applications?''
...
\textbf{Barber\'{a}, P.}, Boydstun, A., Linn, S., McMahon, R., Nagler, J. ``Automated Text Classification of News Articles: A Practical Guide.''
...
\textbf{Barber\'{a}, P.} \& Steinert-Threlkeld, Z. ``Social Media as Data Generators'', submitted as part of the volume \textit{Sag Handbook of Research Methods in Political Science and International Relations}, edited by Robert Franzese and Luigi Curini.
...
\emph{Journal editor}: SAGE Open, special issue on "Social Media and Politics".\nl
