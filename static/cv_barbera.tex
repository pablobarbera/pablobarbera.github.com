...
\emph{Member of dissertation committees:} Adam Badawy (USC), Whitney Hua (USC), Fridolin Linder (Penn State), Xinru Ma (USC), Marius S\"{a}ltzer (Mannheim), Philipp Kling (Konstanz), Joshua Timm (USC), Joe Hoover (USC), Timo Daehler (USC), Anuja Majmundar (USC), Meiqing Zhang (USC), Florence Ecormier-Nocca (SciencesPo), Will Godel (NYU).
