...
%__________________________________________________________________________________________________________________
    ...
    \begin{itemize}
    \item[] Assistant Professor, Dept. of Political Science and International Relations, 2016-- 
    \vspace{-.15cm}
...
\textbf{Barber\'{a}, P.}, Boydstun, A., Linn, S., Nagler, J., McMahon, R.,  \href{http://www.pablobarbera.com/static/text_practical_guide.pdf}{``Automated Text Classification of News Articles: A Practical Guide''}, \textit{Conditionally accepted for publication at Political Analysis}.
...
\textbf{Barber\'{a}, P.}, Theocharis, Y., Popa, S., Fazekas, Z. ``The Dynamics of Citizen Incivility Towards Politicians'', \textit{Accepted for publication at Sage Open}
...
\textit{Paying Attention to Attention: Media Exposure and Opinion Formation in an Age of Information Overload,} 736,600\euro\phantom{} total (81,400\euro\phantom{} assigned to Pablo Barber\'{a}). Volkswagen Foundation. Co-principal investigator, with Simon Munzert, Andrew Guess, JungHwan Yang. 2017.
...
2020: Social Science Foo Camp (O'Reilly and Facebook)
